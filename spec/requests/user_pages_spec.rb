...
describe "UserPages" do
  ...
  describe "signup page" do
    ...
    it { should have_valid_header_and_title('Sign up', 'Sign up') }
  ...
  describe "edit" do
    ...
    describe "page" do
      it { should have_valid_header_and_title("Update your profile", "Edit user") }
    ...
    describe "with valid information" do
      ...
      it { should have_valid_header_and_title(nil, new_name) }
